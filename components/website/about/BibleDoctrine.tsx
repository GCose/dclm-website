...
const doctrines = [
  ...
  },
  {
    ...
    content:
      "That Restitution is making amends for wrongs done against our fellow-men, restoring stolen things to their rightful owners, paying debts, giving back where one has defrauded, making confessions to the offended.",
  },
  {
    id: 7,
    title: "Justification",
    ...
    content:
      "That Justification is God's grace through which one receives forgiveness and remission of sins and is counted righteous before God, through faith in the atoning blood of Jesus.",
  },
  {
    id: 8,
    title: "Water Baptism",
    ...
    content:
      "That water Baptism is essential to our obedience after reconciliation with God. Water Baptism is one immersion 'In the name of the Father, and of the Son, and of the Holy Ghost', as Jesus commanded.",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    content:
      "That the Baptism in the Holy Ghost is the enduement of power from on High upon the sanctified believer, accompanied by the initial evidence of speaking in tongues as the Spirit gives utterance.",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    content:
      "That Marriage is binding for life. Monogamy is the uniform teaching of the Bible. Under the New Testament dispensation, no one has a right to divorce and remarry while the first companion lives.",
  },
  {
    id: 15,
    title: "The Rapture",
    ...
    content:
      "That the Rapture is the catching away from the earth, of all living saints and all who died in the Lord. The Rapture will take place before the Great Tribulation.",
  },
  {
    id: 16,
    ...
    content:
      "That the Resurrection of the dead is taught in the Bible as clearly as the immortality of the soul. Every individual who has ever lived will be resurrected.",
  },
  {
    id: 17,
    ...
    content:
      "That the Great Tribulation will occur after the Rapture and will be a time of terrible suffering on earth. During this time, the Antichrist will take possession of this world.",
  },
  {
    id: 18,
    ...
    content:
      "That the Second Coming of Christ will be just as literal and visible as His going away, and He is coming to execute judgement upon the ungodly.",
  },
  {
    id: 19,
    ...
    content:
      "That Christ's Millennial Reign is the 1,000 years literal reign of Jesus on earth, which will be ushered in by the coming of Jesus back to earth with ten thousands of His saints.",
  },
  {
    id: 20,
    ...
    content:
      "That the Great White Throne Judgement is when God finally judges all who have ever lived on the face of the earth, according to their works. This is after the Millennium.",
  },
  {
    id: 21,
  ...
  },
  {
    ...
    content:
      "That Hell fire is a place of everlasting punishment where sinners will suffer torments for ever and ever. It was prepared for the devil and his angels but the wicked will also be cast there.",
  },
];
    ...
    <section ref={sectionRef} className="relative bg-off-white">
      ...
      <div ref={cardsContainerRef} className="relative h-screen">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-50">
          <p className="text-navy/60 text-sm uppercase tracking-widest">
